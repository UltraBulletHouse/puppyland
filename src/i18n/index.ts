export type Locale = 'en' | 'pl' | 'es' | 'fr' | 'de' | 'it' | 'pt' | 'zh' | 'ja';
...
export const translations = {
  ...
  zh: {
    ...
    subscriptions: '订阅',
    findPosition: '找到你的位置',
    turnOnLocation: '请打开位置',
    turnOnGpsWait: '请打开GPS并等待加载',
    clickButtonBelow: '然后点击下面的按钮',
    signInWithGoogle: '使用谷歌登录',
    health: '生命值',
    availableBuffs: '可用增益',
    confirm: '确认',
    cancel: '取消',
    tapTimesToAttack: '点击 {n} 次进行攻击！',
    tapTimesToRepair: '点击 {n} 次进行修复！',
    notEnoughEnergyNeed: '能量不足！需要 {n} 能量。',
    doghouseFullHealth: '犬屋生命值已满！',
    destroyedText: '已摧毁！',
