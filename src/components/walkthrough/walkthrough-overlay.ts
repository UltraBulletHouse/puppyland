...
export class WalkthroughOverlay extends LitElement {
  static styles = [
    css`
      ...
      .zoom-btn { height: 22px; width: 22px; border-radius: 8px; background: #fff; border: 1px solid #d3d9d4; display: flex; align-items: center; justify-content: center; font-weight: 800; color: var(--color-black); box-shadow: 0 1px 4px rgba(0,0,0,.1); }
      .energy-chip { position: absolute; right: 8px; top: 8px; display: inline-flex; align-items: center; gap: 4px; background: var(--lav-100); border: 1px solid var(--lav); color: var(--lav); border-radius: 999px; padding: 2px 8px; font-weight: 800; font-size: 11px; }
      .add-mini { position: absolute; left: 8px; bottom: 8px; }
      .add-mini::part(base) { height: 28px; width: 28px; border-radius: 12px; background: #fff; border: 1px solid var(--wood); color: var(--wood); box-shadow: 0 1px 4px rgba(0,0,0,.1); }
      .count-mini::part(base) { position: absolute; right: -8px; top: -8px; background: var(--wood); color: #fff; }
      .chips { display: flex; gap: 6px; margin-top: 8px; }
      .chip { display: inline-flex; align-items: center; gap: 4px; background: var(--color-surface); border: 1px solid var(--color-surface-border); border-radius: 999px; padding: 2px 8px; font-size: 11px; }
      ...
      .rank { font-weight: 800; margin-right: 6px; font-size: 12px; }
      .name { flex: 1; }
            ...
            <div class="phone-screen">
              ...
              <div class="phone-content">
                <div class="map-mock mini-map">
                  ...
                  <sl-button class="add-mini" size="small" circle title="${t('walkthrough.ui.addDoghouse')}">
                    <sl-badge class="count-mini" variant="warning" pill>2</sl-badge>
                ...
                <div class="chips">
                  ><span class="chip"><sl-icon name="house-add"></sl-icon> ${t('walkthrough.ui.place')}</span>
                  <span class="chip"><sl-icon name="shield-shaded"></sl-icon> ${t('walkthrough.ui.healX3')}</span>
                  <span class="chip"><sl-icon name="lightning-charge"></sl-icon> ${t('walkthrough.ui.attackX3')}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="phone-frame">
            <div class="phone-screen">
              ...
              <div class="phone-content" style="display:grid; gap:8px;">
                <div class="mini-map" style="height: 80px; border: 1px solid #d3d9d4; border-radius: 8px; background: #fff; position: relative;">
                  <div class="energy-chip" style="top: 6px; right: 6px;"><sl-icon name="lightning-charge"></sl-icon>120</div>
                </div>
    ...
    return html`
      ...
      <div class="panel" @click=${(e: Event) => e.stopPropagation()}>
        <div class="header">
          ...
          <button class="close-btn" @click=${this.close} aria-label="${t('walkthrough.buttons.close')}">✕</button>
        </div>
        <div class="content">
          <div class="text">
